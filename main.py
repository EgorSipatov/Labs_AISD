...
class App:
    def __init__(self, master):
        self.master = master
        self.correct_word = random.choice(open("Words(wordle).txt", "r", encoding='utf-8').read().split())
        ...
        self.master.geometry('%dx%d+%d+%d' % (1175, 1060, 350, 20))
    ...
    def on_help(self):
        ...
        image_help = Image.open("C:/Users/Линар/PycharmProjects/WorkK/Egor_Wordle/help_wordle.png")
